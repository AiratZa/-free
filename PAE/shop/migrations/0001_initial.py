    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_sale', models.CharField(choices=[('p', 'Процент от цены'), ('a', 'Сумма скидки')], max_length=1)),
                ('type_of_currency', models.CharField(blank=True, choices=[('RR', 'Российский рубль'), ('USD', 'American dollar'), ('EUR', 'Euro')], max_length=3, null=True)),
                ...
                ('changed_by', models.ForeignKey(on_delete=models.SET(False), to=settings.AUTH_USER_MODEL)),
